...
<div class="topbar">
  <div class="topbar2">
    ...
    <div class="quick-menu2">
      <ul>
        <li><a title="我的帐户" href="__APP__/Order/queryOrder">我的帐户</a> </li>
...
target div. id must match the href of this div's tab -->
          ...
          <table>
            ...
            <tbody>
            <?php if(is_array($orderlist1)): $i = 0; $__LIST__ = $orderlist1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><tr>
              	<td colspan="7" style="background:#F3F3F3; text-align:left; height:35px;">
                	<strong>订单编号：</strong><?php echo ($vo1["pk_Order_Id"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;   
                    <strong>成交时间:</strong><?php echo ($vo1["Order_Time"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;   
                    <strong>总额:&nbsp;&nbsp; </strong>
                    <span style="color:#900; font-family:Georgia; font-size:18px;"><?php echo ($vo1["Order_Sum"]); ?></span>
                </td>
              </tr>
              <?php if(is_array($orderlist2)): $i = 0; $__LIST__ = $orderlist2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i; if($vo2['Order_Id'] == $vo1['pk_Order_Id']): ?><tr>
                <td font_color="black" style="text-align:left;">
                  <img src="<?php echo ($vo2["Goods_img"]); ?>" width='80' height='80' /><?php echo ($vo2["Goods_Name"]); ?>
                </td>             
                <td font_color="black"><?php echo ($vo2["Goods_Price"]); ?></td>
                <td font_color="black"><?php echo ($vo2["OrderIt_Num"]); ?> </td>
                <td font_color="black"><?php echo ($vo2["Goods_NetContent"]); echo ($vo["Goods_Unit"]); ?></td>
                <td font_color="black">xioaji</td>
                 <?php if($loop == '1'): ?><td font_color="black"><?php echo ($vo2["Order_State"]); ?></td>
                <?php $loop++; endif; ?>
              </tr><?php endif; endforeach; endif; else: echo "" ;endif; ?>
              <?php $loop=1; endforeach; endif; else: echo "" ;endif; ?>
            <?php if($user == '2'): ?><td>japaugugu</td><?php endif; ?>
            </tbody>
          </table>
