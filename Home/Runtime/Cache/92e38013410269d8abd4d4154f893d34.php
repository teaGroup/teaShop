...
<div id="search_main">
       <div class="top">
       <div id="search_top">
       <a href="__ROOT__">首页</a> <code>&gt;</code> 商品搜索_<?php echo ($_POST['keywords']); ?>
       </div>
       <div id="search_way">
       <form action="__APP__/Search/sort" method="post">
	   排序方式：
	   <select name="sort">
       ...
       <div id="good_list">
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="good_single">
				<a href="/"><img src="" width="175" height="175"></a>
		        <a href="/" class="good_name"><?php echo ($vo["Goods_Name"]); ?></a>
		        <span class="good_price"><?php echo ($vo["Goods_Price"]); ?></span>
		        <a href="/" class="good_comment">已有<?php echo $result;?>人评价</a>
		        <p class="buy_panel"><a href="/" class="buy">购买</a></p>
