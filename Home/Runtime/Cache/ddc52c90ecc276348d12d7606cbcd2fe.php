...
<meta charset="utf-8">
<title>无标题文档</title>
<link rel="stylesheet" href="__PUBLIC__/css/h-n.css" type="text/css" media="screen" />
  ...
  <div class="cartinfo" id="cartinfo" style="left: 326px;">
    ...
    <div class="cartright"> <a href="__APP__/Order/consignee"></a> </div>
     ...
     <form action="" method="post" enctype="multipart/form-data" name="form2">
        <input type="hidden" name="id" value="<?php echo ($data["pk_News_Id"]); ?>"/>
        <label for="news_title" id="font">新闻标题：</label>
     	<input type="text" id="news_title" name="news_title" value="<?php echo ($data["News_Title"]); ?>"/><p></p>
        <label for="news_content" id="font">新闻内容：</label>
        <textarea name="news_content"><?php echo ($data["News_Content"]); ?></textarea><br/>
