...
<body>
     ...
     <br/>
         ...
         <form action="__APP__/ManageAdmin/insert" method="post" enctype="multipart/form-data" name="form1">
         <fieldset>
            <p>
           ...
           <p>
             <label for="admin_authority">权限：</label>
                 <input type="text" name="admin_authority" id="admin_authority">
             <br/>
           </p>
           <p>
             <label for="admin_role">角色：</label>
                 <input type="text" name="admin_role" id="admin_role">
             <br/>
           </p>
