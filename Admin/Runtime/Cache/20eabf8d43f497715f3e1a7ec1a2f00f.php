...
<html>
	...
	<body>
		﻿
		 ...
		 <link rel="stylesheet" href="__PUBLIC__/css/myStyle.css" type="text/css" media="screen"/>
	    ...
	    <div id="body-wrapper"> 
			...
			<div id="profile-links">
				...
				<br />
				<a href="__ROOT__/index.php/Index/index" title="View the Site">网站首页</a> | <a href="#" title="Sign Out">注销登录</a>
			</div>
			<ul id="main-nav"> 
				...
				<li> 
					...
					<ul>
						...
						<li><a class="current" href="__APP__/Goodsinfo/index">商品信息管理</a></li>
